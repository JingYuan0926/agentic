        ...
        const response = await createChatCompletion(selectedModel, [
            {
                ...
                5. DO NOT use constructor, use initialize function instead
                ...
                11. Optimize for Flow EVM chain
                12. Include gas optimizations
                13. Add appropriate events
                14. Include proper error handling
                15. Add input validation
                16. Make sure the contract is secure and cannot be exploited
                17. Make sure transaction functions are payable.`
            },
            {
                role: "user",
